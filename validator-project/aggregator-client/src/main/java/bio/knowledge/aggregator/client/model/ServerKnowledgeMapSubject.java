...
public class ServerKnowledgeMapSubject {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "the CURIE designating the concept type of a  statement subject ")
  public String getId() {
    return id;
  }
   ...
   * @return label
  **/
  @ApiModelProperty(example = "null", value = "the human readable label of the concept type of a statement subject ")
