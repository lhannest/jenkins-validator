...
public class MetadataApiTest {
    ...
    public void getBeaconsTest() throws ApiException {
        List<ServerKnowledgeBeacon> response = api.getBeacons();
    ...
    public void getConceptTypesTest() throws ApiException {
        ...
        List<ServerConceptTypes> response = api.getConceptTypes(beacons);
    ...
    public void getErrorsTest() throws ApiException {
        String queryId = null;
        List<ServerLogEntry> response = api.getErrors(queryId);
    ...
    public void getKnowledgeMapTest() throws ApiException {
        List<Integer> beacons = null;
        List<ServerKnowledgeMap> response = api.getKnowledgeMap(beacons);
    ...
    public void getPredicatesTest() throws ApiException {
        List<Integer> beacons = null;
        List<ServerPredicates> response = api.getPredicates(beacons);
